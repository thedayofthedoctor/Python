...
def fun_ope_chwp(inpt_link):
    ...
    ope_chro.implicitly_wait(10)
    return ope_chro

def fun_ope_chrp(inpt_link):
    ope_chro=webd.Chrome()
    ope_chro.minimize_window()
    ope_chro.get(inpt_link)
    ope_chro.implicitly_wait(5)
    return ope_chro
...
def main():
    print('开始爬取.')
    url_comi='http://m.manhuaju.com/zhiyu/qingwenninjintianyaolaidiantuzima/'
